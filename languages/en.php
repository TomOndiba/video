...
$lang = array(
	...
	'video:enablevideo' => 'Enable group videos',
     ...
     *
     */ 
         'video:menu:topbar' => "My profile",
         'video:loginregister' => "Login / register",
	 'video:gotohomepage' => "Go to home page",
         'video:usersettings' => "My Settings",
	 'video:myprofile' => "My Profile",
	 'video:help' => "Help",
	
	 'video:friendinvite' => "pending friendship request",
	 'video:friendinvites' => "pending friendship requests",
	 
	 'videos:upload' =>"Upload",
	 
	 
	 'watch:later'  => "Want to watch this again later?",
	 'sign:in:add:playlist' => "Sign in to add this video to a playlist. ",
    /*
    *  'video:movie' => "Movie",
    *
    */     
...
<p>Changing these settings only affects the videos added in the future..</p>',
	...
	'flavor:delete:confirm' => 'Are you shure you want to delete this Flavor',
